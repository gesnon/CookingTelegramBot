# CookingTelegramBot Polling Example
...
You have to add [CookingTelegramBot](https://www.nuget.org/packages/CookingTelegramBot/) 
nuget package to your project to be able to use polling:

```shell
dotnet add package CookingTelegramBot
```
...
```xml
<ItemGroup>
  <PackageReference Include="CookingTelegramBot" Version="18.0.0" />
</ItemGroup>
```
